...
HD_PWD='/home/diezec/workspace/lab2/vivado/lab2.runs/Lab2_SoC_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_SoC_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab2_SoC_auto_pc_0.tcl
