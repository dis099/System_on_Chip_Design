...
HD_PWD='/home/diezec/workspace/lab2/vivado/lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab2_SoC_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab2_SoC_wrapper.tcl -notrace
